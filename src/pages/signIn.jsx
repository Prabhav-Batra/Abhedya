    ...
    <div className="flex justify-center items-center ">
      ...
      <div className="bg-slate-50/20 w-3/4 md:w-130 rounded-xl py-8 px-10 backdrop-blur-[3px] md:ml-30 mr-0 sm:mt-[10%] mt-[40%] border-2 border-teal-800">
        ...
        <div className="mt-7 flex justify-center items-center">
          <Button text={"Sign In"} variant={"main"} size={"fxl"} />
        </div>
        ...
        <p className="text-[#f9f9f9] text-lg md:text-lg m-3 ">
          <span className="opacity-50">New to Abhedya </span>
          <span className="opacity-100 underline font-bold cursor-pointer text-teal-500">
            Sign Up
          </span>
        </p>
      </div>
      <div className="w-3/4 h-full m-10 hidden md:block ">
        <img
          className="object-cover absolute bottom-0 right-20 -scale-x-100  md:w-120 md:h-140 "
          src="../../../rb_25585 2.png"
        />
      </div>
    </div>
