...
export const GamePage = () => {
  return (
    <div className="relative min-h-screen bg-transparent text-[rgba(0,170,190,1)] flex flex-col backdrop-blur-[1px] items-center justify-center p-6 ">
      ...
      {/* Questions Section */}
      <div className="absolute top-[160px] w-[calc(100%-64px)] mx-[128px] rounded-2xl border-[1.25px] border-[rgba(0,191,163,1)]/60 shadow-md transition-all duration-300 hover:scale-101 hover:shadow-cyan-500/50 p-6 bg-black"
        style={{ minHeight: "calc(100vh - 170px)", height: "auto", maxHeight: "calc(100vh - 180px)" }}> {/* Adjusted height */}
...
<div className="flex flex-col lg:flex-row w-full h-full">
  ...
  <div className="w-full flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden max-h-[60vh] lg:max-h-[50vh]">
