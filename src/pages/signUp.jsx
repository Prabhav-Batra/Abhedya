    ...
    <div className="flex flex-col justify-center min-h-screen">
      ...
      <div className="md:py-4 md:px-12 flex justify-center items-center min-h-screen">
        <div className="w-3/4 h-full m-10 hidden md:block ">
          <img
            className="object-cover absolute bottom-0 left-20 md:w-100 md:h-110 "
            src="../../../rb_25585 2.png"
          />
        </div>
        <div className="bg-slate-50/20 w-full md:w-130 rounded-xl py-8 px-10 backdrop-blur-[3px] md:mr-30 mr-0">
          <LinearGradientText
            text={"Sign Up"}
