...
export const CenterImage = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div
        ref={box1}
        className=" absolute -rotate-0 md:w-[20vw] md:h-[20vw] sm:w-56 sm:h-56 w-44 h-44 rounded-xl bg-[#0E3F3A] border border-teal-100/10"
      ></div>
      <div
        ref={box2}
        className="relative sm:w-56 md:w-[20vw] md:h-[20vw] sm:h-56 w-44 h-44 rounded-xl bg-gradient-to-br from-[#031615] to-[#115E59] rotate-0 border border-teal-100/20 shadow shadow-teal-950"
