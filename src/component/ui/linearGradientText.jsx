...
const sizeStyles = {
  ...
  md: "text-7xl text-center pb-5 pr-1",
};

const defaultStyles =
  " font-[poppins] tracking-tighter text-transparent bg-clip-text bg-[linear-gradient(to_bottom,#ffffff_5%,#76807F_60%,#515C5C_69%,#1e1e1e_90%)] font-extrabold whitespace-nowrap";
