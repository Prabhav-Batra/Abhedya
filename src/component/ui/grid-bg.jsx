export const GridBg = ({ children, leftLight, rightLight }) => {
  return (
    <div className="relative bg-[size:40px_40px] bg-[image:linear-gradient(to_right,#1c1c1c_2px,transparent_2px),linear-gradient(to_bottom,#1c1c1c_2px,#0c0c0c_1px)] min-h-[45vw] w-full overflow-x-hidden ">
      {leftLight && (
        <div
